...
my_tree
```
## Second tree model, with adjusted tuning parameters to see what happens
...
my_tree_2
```
## Here is the third classification tree with adjusted parameters in the other direction
...
# Random Forest model time! This one will be different because instead of changing the predictors we will change the 'mtry' value. First we will fit a sequence of mtry's and see which one is best. 
