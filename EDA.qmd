...
```{r}
# set the directory
setwd("/Users/kyrakapsaskis/ST558 Final Project Folder/ST558-Final-Project")
...
diabetes_data <- read.csv("/Users/kyrakapsaskis/ST558 Final Project Folder/ST558-Final-Project/diabetes_binary_health_indicators_BRFSS2015.csv")
...
```{r}
twoway_table1 <- table(factor_data[, c("Diabetes_factor", "Sex_factor")])
twoway_table2 <- table(factor_data[, c("Diabetes_factor", "Sex_factor")])
twoway_table3 <- table(factor_data[, c("Diabetes_factor", "Sex_factor")])
twoway_table4 <- table(factor_data[, c("Diabetes_factor", "Sex_factor")])
twoway_table5 <- table(factor_data[, c("Diabetes_factor", "Sex_factor")])
```
...
my_graph2 <- ggplot(factor_data |> 
                   ...
                   aes(x = PhysHlth, y = MentHlth, fill = PhysHlth)) 
...
```{r}
my_table <- table(factor_data$Diabetes_factor, factor_data$PhysHlth)
plot(my_table)
```
