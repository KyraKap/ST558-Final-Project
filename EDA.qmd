...
For this project, we will be looking at diabetes data that includes various of risk factors and health-related variables that we can assess for their influence on whether or not a person has diabetes.
